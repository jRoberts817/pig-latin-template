public class App {
    public static void main(String[] args)
    {
        ...
        test.readFromUrl("War of the Worlds", "https://www.gutenberg.org/cache/epub/36/pg36.txt");

        Book output = PigLatinTranslator.translate(input);
        Book testOutput = PigLatinTranslator.translate(test);
        testOutput.writeToFile();
        output.writeToFile();
    }
}
